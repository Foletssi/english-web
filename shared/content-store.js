(function(global){
  ...
  const seed={
    ...
    videos:[
      {id:2805,title:'How I Start My Day in the English Countryside',titleZh:'我在英国乡村如何开始一天',description:'Real-life comprehensible input from a calm English countryside morning.',creatorId:'creator-jojo',creator:'Jojo English',collectionIds:[36],level:'A2–B1',category:'日常生活',duration:30,cover:'assets/images/home_video_1.png',mediaUrl:'assets/video/sample_lesson.mp4',status:'PUBLISHED',pipelineStatus:'READY',publishedAt:'2026-08-28T08:00:00.000Z',updatedAt:now()},
      {id:2806,title:'A Slow Morning Routine With Natural English',titleZh:'用自然英语开启慢节奏早晨',description:'Slow natural English for everyday routines.',creatorId:'creator-jojo',creator:'Jojo English',collectionIds:[36,12],level:'A2',category:'日常生活',duration:1120,cover:'assets/images/home_video_2.png',mediaUrl:'assets/video/sample_lesson.mp4',status:'PUBLISHED',pipelineStatus:'READY',publishedAt:'2026-08-25T08:00:00.000Z',updatedAt:now()},
      ...
      {id:2812,title:'Nature Walk English: Forest Sounds and Words',titleZh:'自然漫步英语：森林声音与词汇',description:'Simple nature vocabulary in a calm listening context.',creatorId:'creator-nature',creator:'Nature Notes',collectionIds:[106],level:'A1',category:'自然',duration:603,cover:'assets/images/home_video_3.png',mediaUrl:'assets/video/sample_lesson.mp4',status:'PUBLISHED',pipelineStatus:'READY',publishedAt:'2026-07-30T08:00:00.000Z',updatedAt:now()},
