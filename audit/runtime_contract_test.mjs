...
const created=S.saveVideo({id:99001,title:'Draft Contract Video',creatorId:'creator-jojo',creator:'Jojo English',level:'A2',status:'DRAFT',pipelineStatus:'READY',mediaUrl:'assets/video/sample_lesson.mp4'});
