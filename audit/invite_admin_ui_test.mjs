...
const available={id:'22222222-2222-4222-8222-222222222222',batchId:batch.id,codeHint:'9K2F',label:batch.label,channel:batch.channel,durationDays:30,validUntil:'2026-10-11T06:00:00Z',createdAt:'2026-09-11T06:00:00Z',status:'available'};
const used={...available,id:'33333333-3333-4333-8333-333333333333',codeHint:'A8M4',status:'used',redeemedBy:'44444444-4444-4444-8444-444444444444',redeemedPhone:'+8613888888888',redeemedNickname:'测试学员',redeemedAt:'2026-09-11T07:00:00Z',entitlementExpiresAt:'2026-10-11T07:00:00Z'};
...
assert.equal(await page.getByText('EAST-••••-9K2F').count(),1);
...
await page.getByText('明文只显示这一次，请立即复制或下载 CSV。').waitFor();
